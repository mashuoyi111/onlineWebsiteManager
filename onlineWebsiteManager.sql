...
web_url varchar(400) default 'about:blankwebsitestags' not null comment 'url of a website',
...
insert into users(user_name,password,nickname) values("xinwei",sha1("123"),"Wendy");
